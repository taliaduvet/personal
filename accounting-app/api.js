import { handleSupaResult } from './js/ledger-api-helpers.js';
...
function getClient() {
  ...
  const key = typeof globalThis.SUPABASE_ANON_KEY !== 'undefined' ? globalThis.SUPABASE_ANON_KEY : '';
  if (!url || !key) {
...
window.acctApi = {
  ...
  async incomeList() {
    ...
    return handleSupaResult('incomeList', { data: data || [], error });
  },
  ...
  async incomeInsert(row) {
    ...
    return handleSupaResult('incomeInsert', { data, error });
  },
  ...
  async incomeUpdate(id, row) {
    ...
    return handleSupaResult('incomeUpdate', { data, error });
  },
  ...
  async expensesList() {
    ...
    return handleSupaResult('expensesList', { data: data || [], error });
  },
  ...
  async expensesInsert(row) {
    ...
    return handleSupaResult('expensesInsert', { data, error });
  },
  ...
  async expensesUpdate(id, row) {
    ...
    return handleSupaResult('expensesUpdate', { data, error });
  },
  ...
  async incomeInRange(fromDate, toDate) {
    ...
    const u = await getUid();
    if (!sb || !u) return { data: [], error: 'Not authenticated' };
    const q = sb.from('acct_income').select('*').eq('user_id', u).gte('date', fromDate).lte('date', toDate).order('date', { ascending: false });
    const { data, error } = await q;
    return handleSupaResult('incomeInRange', { data: data || [], error });
  },
  ...
  async expensesInRange(fromDate, toDate) {
    ...
    return handleSupaResult('expensesInRange', { data: data || [], error });
  },
  ...
  async plannedList() {
    ...
    return handleSupaResult('plannedList', { data: data || [], error });
  },
  ...
  async plannedInsert(row) {
    ...
    return handleSupaResult('plannedInsert', { data, error });
  },
  ...
  async plannedUpdate(id, row) {
    ...
    return handleSupaResult('plannedUpdate', { data, error });
  },
  ...
  async bankInsertMany(rows) {
    ...
    return handleSupaResult('bankInsertMany', { data: data || [], error });
  },
  ...
  async bankListKeysForDedup() {
    ...
    const { data, error } = await sb
      ...
      .eq('user_id', u);
    return handleSupaResult('bankListKeysForDedup', { data: data || [], error });
  },
  ...
  async bankListUnreconciled() {
    ...
    return handleSupaResult('bankListUnreconciled', { data: data || [], error });
  },
  ...
  async createReconciliation(bankTransactionId, incomeId, expenseId) {
    ...
    return handleSupaResult('createReconciliation', { data, error });
  },
  ...
  async rulesList() {
    ...
    return handleSupaResult('rulesList', { data: data || [], error });
  },
  ...
  async rulesInsert(row) {
    ...
    const { data, error } = await sb
      ...
      .select()
      .single();
    return handleSupaResult('rulesInsert', { data, error });
  },
  ...
  async listReceipts(expenseId) {
    ...
    return handleSupaResult('listReceipts', { data: data || [], error });
  },
  ...
  async uploadReceipt(expenseId, file) {
    ...
    const { data, error } = await sb
      ...
      .select()
      .single();
    return handleSupaResult('uploadReceipt', { data, error });
  },
...
window.gfApi = {
  async productsList() {
    ...
    return handleSupaResult('productsList', { data: data || [], error });
  },
  ...
  async productUpsert(row) {
    ...
    if (row.id) {
      ...
      return handleSupaResult('productUpsert(update)', { data, error });
    }
    delete payload.id;
    const { data, error } = await sb.from('gf_products').insert(payload).select().single();
    return handleSupaResult('productUpsert(insert)', { data, error });
  },
  ...
  async purchasesList(opts) {
    ...
    const { data, error } = await q;
    return handleSupaResult('purchasesList', { data: data || [], error });
  },
  ...
  async purchaseInsert(row) {
    ...
    return handleSupaResult('purchaseInsert', { data, error });
  },
  ...
  async purchaseUpdate(id, row) {
    ...
    return handleSupaResult('purchaseUpdate', { data, error });
  },
  ...
  async gfReceiptsList() {
    ...
    return handleSupaResult('gfReceiptsList', { data: data || [], error });
  },
  ...
  async gfReceiptsByIds(ids) {
    ...
    return handleSupaResult('gfReceiptsByIds', { data: data || [], error });
  },
  ...
  async gfReceiptUpload(file, receiptDate) {
    ...
    return handleSupaResult('gfReceiptUpload', { data, error });
  },
  ...
  async gfReceiptUpdate(id, payload) {
    ...
    return handleSupaResult('gfReceiptUpdate', { data, error });
  },
