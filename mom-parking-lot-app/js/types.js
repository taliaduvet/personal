 ...
 * @property {'daily'|'weekly'|'monthly'|'quarterly'|'semi_monthly'|null} [recurrence]
 * @property {{ type?: string, anchorDate?: string, dayOfMonth?: number, days?: number[], intervalDays?: number, weekdays?: number[] }|null} [recurrenceRule]
 ...
 * @property {'column'|'standalone'|'day'} source
